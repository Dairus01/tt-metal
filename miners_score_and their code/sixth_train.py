#This is the miner whose training code scores sixth on the mining leaderboard, his MFU is 49.73%, 
#"mfu": 49.72960704707201,
#"tokens_per_second": 6791.149639357641,
#"total_tokens": 655360,
#"wall_time_seconds": 96.5020703125, here is his code:
...
flash_ce = _FlashCELoss(ignore_index=-100)
...
def inner_steps(model, data_iterator, optimizer, num_steps, device, num_gpus=1):
    ...
    for step in range(num_steps):
        ...
        loss = flash_ce(logits.view(-1, logits.size(-1)), all_labels[step].view(-1))        
        loss.backward()
        opt_step()
