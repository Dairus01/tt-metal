...
class Generator:
    ...
    def _easy_trace_prefill(
        ...
        **kwargs,
        ...
        # Include batch_size in trace_key for batched prefill (different batch sizes need different traces)
        ...
        **kwargs,
        ...
        for idx, user_id in enumerate(all_users):
            ...
            if use_batched_prefill:
                ...
                # Skip the rest of the loop for batched prefill - we processed all users inline
                continue
