...
from models.demos.vision.generative.stable_diffusion.wormhole.common import SD_L1_SMALL_SIZE, SD_TRACE_REGION_SIZE
...
def test_stable_diffusion_device_perf(expected_kernel_samples_per_second):
    ...
    batch = 1
    iterations = 1
    command = f"pytest models/demos/vision/generative/stable_diffusion/wormhole/tests/test_unet_2d_condition_model.py::test_unet_2d_condition_model_512x512[2-4-64-64-device_params=l1_small_size_24576]"
...
def test_stable_diffusion_vae_device_perf(expected_kernel_samples_per_second):
    ...
    batch = 1
    iterations = 1
    command = f"pytest models/demos/vision/generative/stable_diffusion/wormhole/tests/vae/test_vae.py::test_decoder[4-64-64-3-512-512-device_params0]"
    cols = ["DEVICE FW", "DEVICE KERNEL", "DEVICE BRISC KERNEL"]
