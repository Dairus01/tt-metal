...
from models.demos.deepseek_v3_b1.blitz_decode_weights import GATE_UP_PROJ_OVERLAP_CFG
...
def test_shared_expert(device, K_gate, N_per_core, weights_dtype):
    ...
    # Core grids
    # ========================================================================
    gate_up_cfg = GATE_UP_PROJ_OVERLAP_CFG
