...
void run_in_dfb_out_dfb_program(
    ...
    experimental::dfb::CreateDataflowBuffer(program, logical_core, dm2tensix_config);
    experimental::dfb::CreateDataflowBuffer(program, logical_core, tensix2dm_config);
    ...
    SetRuntimeArgs(
        ...
        compute_kernel,
        logical_core,
        {(uint32_t)dm2tensix_config.consumer_risc_mask, tensix2dm_config.producer_risc_mask});
    SetRuntimeArgs(program, consumer_kernel, logical_core, {(uint32_t)tensix2dm_config.consumer_risc_mask});
