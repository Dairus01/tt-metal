...
# BF16
# pytest tests/ttnn/unit_tests/operations/eltwise/test_binary_pow_exhaustive.py::test_pow_tt_BF16_exhaustive_test

# FP32
# pytest tests/ttnn/unit_tests/operations/eltwise/test_binary_pow_exhaustive.py::test_pow_tt_FP32_exhaustive_test
