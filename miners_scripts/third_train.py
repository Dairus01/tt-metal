#This is the miner whose training code scores third on the mining leaderboard, his MFU is 56.14%, 
#"mfu": 56.14184338525645,
#"tokens_per_second": 7666.814240011289,
#"total_tokens": 655360,
#"wall_time_seconds": 85.48009375,here is his code:
...
def _prepare_model(model):
    ...
    # Force a single stable layer index so torch.compile does not specialize per layer.
...
def inner_steps(model, data_iterator, optimizer, num_steps, device, num_gpus=1):
    ...
    for step in range(num_steps):
        ...
        loss = _flash_ce(logits.view(-1, logits.size(-1)), all_labels[step].view(-1))
