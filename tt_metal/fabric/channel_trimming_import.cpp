...
int parse_noc_send_type(const std::string& name) {
    if (name == "NOC_UNICAST_WRITE") return NocSendType::NOC_UNICAST_WRITE;
    if (name == "NOC_UNICAST_INLINE_WRITE") return NocSendType::NOC_UNICAST_INLINE_WRITE;
    if (name == "NOC_UNICAST_ATOMIC_INC") return NocSendType::NOC_UNICAST_ATOMIC_INC;
    if (name == "NOC_FUSED_UNICAST_ATOMIC_INC") return NocSendType::NOC_FUSED_UNICAST_ATOMIC_INC;
    if (name == "NOC_UNICAST_SCATTER_WRITE") return NocSendType::NOC_UNICAST_SCATTER_WRITE;
    if (name == "NOC_MULTICAST_WRITE") return NocSendType::NOC_MULTICAST_WRITE;
    if (name == "NOC_MULTICAST_ATOMIC_INC") return NocSendType::NOC_MULTICAST_ATOMIC_INC;
    if (name == "NOC_UNICAST_READ") return NocSendType::NOC_UNICAST_READ;
    return -1;
}
